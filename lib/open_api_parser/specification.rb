module OpenApiParser
  module Specification
    META_SCHEMA_PATH_2 = File.expand_path("../../../resources/swagger_meta_schema_2.0.json", __FILE__)
    META_SCHEMA_PATH_3 = File.expand_path("../../../resources/swagger_meta_schema_3.0.json", __FILE__)
